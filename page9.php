...
$student_class = "M.6/9";  //ระบุห้องที่ต้องการนำเสนอ
...
<img src="images/banner-9.png" alt=" " style="width:100%" >
<center>
...
<div class="w3-center">
	<div class="w3-bar w3-large">
		<a href="page9.php?page=1" class="w3-hover-green"> &laquo; </a>
		<?php for($i=1;$i<=$total_page;$i++){ ?>
		<a href="page9.php?page=<?php echo $i; ?>" class="w3-hover-green"><?php echo $i; ?></a>
		<?php } ?>
		<a href="page9.php?page=<?php echo $total_page;?>" class="w3-hover-green">&raquo;</a>
	</div>
</div>
